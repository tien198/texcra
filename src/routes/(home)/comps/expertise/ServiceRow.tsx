  ...
  return (
    <a
      className={clsx(
        ...
        light ? 'border-[#e6e6df66] text-[#f5f2eb] light' : ''
      )}
      href="#contact"
      aria-label={title}
    >
      <span
        className={clsx(
          'text-[#4b555a] group-[.light]:text-[#dce0dd] font-heading font-[200] text-[12px] tracking-[1.8px] pt-[6px] md:pt-0'
        )}
      >
        {number}
      </span>
      ...
      <div
        className={clsx(
          'grid gap-[18px] md:gap-[20px] text-[#465157] group-[.light]:text-[#dce0dd] col-[2_/_4] row-[2] md:col-auto md:row-auto'
        )}
      >
        ...
        <span
          className={clsx(
            'text-[#4b555a] group-[.light]:text-[#dce0dd] font-heading font-[200] text-[9px] md:text-[10px] leading-[1.6] tracking-[1.7px] md:tracking-[2.4px]'
          )}
        >
          {scope}
        </span>
