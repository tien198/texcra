...
export function ExpertiseSection() {
  return (
    <section
      id="expertise"
      className={clsx(
        'relative isolate flex flex-col items-center min-h-[1204px] md:min-h-[1241px] pt-[0] md:pt-[20px] px-[24px] md:px-[5%] pb-[64px] md:pb-[96px] text-[#17242b]',
        'bg-[radial-gradient(ellipse_100%_130%_at_50%_130%,#c4d5e7_45%,#fdfbf7_85%,#f7f7f5)]'
      )}
      aria-labelledby="expertise-heading"
    >
      <Atmosphere reverse />
      <div className={clsx('w-full max-w-[1456px] mx-auto flex-1 flex flex-col')}>
        <ExpertiseIntro />
        <div
          className={clsx(
