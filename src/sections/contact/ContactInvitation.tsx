...
export function ContactInvitation() {
  ...
  return (
    <div className={clsx('flex flex-col gap-[24px] md:gap-[28px]')}>
      ...
      >
        <MessageUI locale={locale} message={m.home_contact_eyebrow} />
      </p>
      <h2
        id="contact-heading"
        className={clsx(
      ...
      >
        <MessageUI locale={locale} message={m.home_contact_title} />
      </h2>
      <p
        className={clsx(
      ...
      >
        <MessageUI locale={locale} message={m.home_contact_description} />
      </p>
    </div>
  )
}
