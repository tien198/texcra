...
export function ContactInvitation() {
  return (
    <div className={clsx('flex flex-col gap-[24px] md:gap-[28px]')}>
      <p
        className={clsx(
          'text-[#bddfff] font-heading font-[200] text-[9px] md:text-[10px] tracking-[2.2px] md:tracking-[2.4px]'
        )}
      >
      ...
      <h2
        id="contact-heading"
        className={clsx(
          'font-heading font-[200] text-[44px] md:text-[60px] leading-[1.12] tracking-[2.8px] md:tracking-[3.2px] whitespace-pre-line'
        )}
      >
